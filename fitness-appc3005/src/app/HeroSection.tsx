...
const ExampleDisplay = ({
  ...
  isVisible: boolean;
  selectedPill: keyof typeof iconMap;
}) => {
  return (
    <div
    ...
    >
      <div className="relative bg-white dark:bg-gray-950 rounded-lg sm:rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden transition-colors duration-300">
        ...
        <div className="bg-gray-900">
          <img
            src={`/example${selectedPill}.png`}
            alt="Example of a Member's Profile"
    ...
    <div className="font-sans">
      ...
      <div className="px-4 transition-colors duration-300">
        <div className="max-w-7xl mx-auto">
          <div
            className={`text-center mb-4 sm:mb-8 transition-all duration-500 ease-out ${
              isVisible
          ...
          >
            <ExampleDisplay isVisible={isVisible} selectedPill={selectedPill} />
          </div>
        </div>
      </div>
    </div>
